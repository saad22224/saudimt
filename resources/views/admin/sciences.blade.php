    ...
    <main class="main-content">
        ...
        <div class="page-content" id="users">
            ...
            <div class="search-box">
                ...
                <input type="text" placeholder="البحث في العلماء..." id="userSearch">
            </div>
                ...
                <table class="data-table">
                    ...
                    <tbody id="usersTableBody">
                        @foreach ($sciences as $science)
                            <tr>
                                <td>
                                    <img src="{{ asset($science->image) }}" alt="صورة الهوية الأمامية"
                                ...
                                <td>{{ $science->title_ar }}</td>
                                <td>{{ $science->title_en }}</td>
                                <td>{{ $science->desc_ar }}</td>
                                <td>{{ $science->desc_en }}</td>
                                {{-- <td>{{ $user->balance }}</td> --}}
                                ...
                                <td>
                                    ...
                                    <!-- زر حذف -->
                                    <form action="{{ route('admin.deletescience', $science->id) }}" method="post"
